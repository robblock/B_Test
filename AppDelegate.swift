...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //MARK: - Setting up Parse
        Parse.enableLocalDatastore()
        
        Parse.setApplicationId("2WTKqGWXyejbEZojk2l7zNGWrWLd6mNfWcZ5CvNR",
            clientKey: "14PYFMaRTEcZgMaz31ofX185OBNHC3dGfc4k7Mni")
...
//        registerForNotifications(application)
    ...
    //Allows Facebook to track app usage
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.robblock.beacons_test" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("beacons_test", withExtension: "momd")!
